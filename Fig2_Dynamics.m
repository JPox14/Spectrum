...
Kmi = 0.05;  %focal strain -> community
Kmr = 0.05; %ignore
Kms = 0.05; %conspecific strain -> community
...
GamR = 0.14027;        %production rate
%Production rate taken from Investment_ESS for fully broad toxin.    
GamRi = GamR;
GamRr = 0;        %ignore
GamRS = GamR;
