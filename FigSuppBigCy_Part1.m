...
cy = 0.0003;       %Community abundance T0
...
cr = 0;
eCelery = cell(1,dp+1);
eCeleryM = cell(1,dp+1);
eCeleryP = cell(1,dp+1);
eCelery0 = cell(1,dp+1);
    ...
    gc = 0;
        ...
        for GamRi = GamRi0:gi:GamRiF
            ...
            for GamRS = GamRs0:gr:GamRsF
                gt = gt + 1;
                y = [Sy Pry Piy*(1-AS) cy gamS0 gamr0 gami0 Nu1 Nu2];
                y0 = y;
                %First time
                ci = GamRi; 
                cS = GamRS;
                ...
                %do it again
                y = [Sy*(1-AS) Pry Piy cy gamS0 gamr0 gami0 Nu1 Nu2];
                y0 = y;
                eventfunc = @(t,y) steadystateNutEx(t, y, r, cS, ci, cr, gamD,Kn1,Kn2,Kmi,Kmr,Kms,Km,NO1,NO2,E,DEG,HCE);
                optionsode=odeset('Events',eventfunc);
                if DEG == 1
                    [t,y,te,ye,ie] = ode45(@(t,y) LVfunc_Ex(t, y, r, cS, ci, cr, gamD,Kn1,Kn2,Kmi,Kmr,Kms,Km,NO1,NO2,E,HCE),tspan, y0,optionsode);
                else
                    [t,y,te,ye,ie] = ode45(@(t,y) LVfunc_Ex_NoDeg(t, y, r, cS, ci, cr, gamD,Kn1,Kn2,Kmi,Kmr,Kms,Km,NO1,NO2,E,HCE),tspan, y0,optionsode);
        ...
        eCeleryM{1,ic} = endvalM;
        eCeleryP{1,ic} = endvalP;
        eCelery0{1,ic} = endvali0;
end   

save('C:\Users\jdpal\Desktop\Local\Data\FigSupplement3_AS06_cy3','eCelery')
